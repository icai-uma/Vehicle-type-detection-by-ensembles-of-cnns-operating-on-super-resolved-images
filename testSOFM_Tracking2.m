...
homedir = getenv('HOME');
% if strcmpi(homedir,'/home/rmluque')
%     params.MatlabProjectsDirectory = '/home/rmluque/Dropbox/ArticulosRedactados/ICAE_2018/';
% elseif strcmpi(homedir,'/Users/rafaelmarcos')
%     params.MatlabProjectsDirectory = '/Users/rafaelmarcos/Dropbox/ArticulosRedactados/ICAE_2018/';
% else
%     error('Indica el directorio raiz del proyecto');
% end
params.MatlabProjectsDirectory = '/home/icai21/Modelos/codigos/icae/iwinac/';
params.CarsVideosDirectory = strcat(params.MatlabProjectsDirectory,'videos/');

sName=strcat(params.CarsVideosDirectory,'sb-camera2-0750am-0805am.avi');
sName=strcat(params.CarsVideosDirectory,'lankershim-camera3-0830am-0845am.avi');
...
if captura 
    mov = VideoWriter([postModel.path datestr(now,30) '.avi']);
    mov.FrameRate = 25;
    open(mov);
end
...
%         
        ...
        if i >= postModel.StartCuttingObjects
            ...
            tKalman_v = tic;
            kModel = deepLabellingVehicles_Matlab(kModel,postModel);
            %kModel = deepLabellingVehicles(kModel);
