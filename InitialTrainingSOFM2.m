function Model = InitialTrainingSOFM2(ModelInput, Samples, NdxFrameIni)
...
for NdxRow=1:Model.NumRowsMap
    ...
    for NdxCol=1:Model.NumColsMap
        ...
        % Normalizamos dividiendo por la media del training
        Model.Prototypes(3:5,NdxRow,NdxCol)=ones(3,1) + (temp(3:5) ./ Mu(3:5));  
